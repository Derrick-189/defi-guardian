...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 22: // STATE 10 - _spin_nvr.tmp:8 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM never_0 */
	case 23: // STATE 1 - /home/slade/defi_guardian/generated/models/translated_output.pml:77 - [(((state==1)&&(lock==1)))] (0:0:0 - 1)
		...
		if (!(((((int)now.state)==1)&&(((int)now.lock)==1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 24: // STATE 3 - /home/slade/defi_guardian/generated/models/translated_output.pml:78 - [((state==2))] (0:0:0 - 1)
		...
		if (!((((int)now.state)==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 25: // STATE 5 - /home/slade/defi_guardian/generated/models/translated_output.pml:79 - [((state==0))] (0:0:0 - 1)
		...
		if (!((((int)now.state)==0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 26: // STATE 10 - /home/slade/defi_guardian/generated/models/translated_output.pml:81 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Contract */
	case 27: // STATE 1 - /home/slade/defi_guardian/generated/models/translated_output.pml:38 - [printf('Formal Verification: Contract Initialized\\n')] (0:26:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		Printf("Formal Verification: Contract Initialized\n");
		/* merge: state = 1(26, 2, 26) */
		reached[0][2] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 28: // STATE 4 - /home/slade/defi_guardian/generated/models/translated_output.pml:43 - [((state==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		if (!((((int)now.state)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 29: // STATE 5 - /home/slade/defi_guardian/generated/models/translated_output.pml:45 - [assert((user_collateral>=0))] (0:17:1 - 1)
		IfNotBlocked
		reached[0][5] = 1;
		spin_assert((now.user_collateral>=0), "(user_collateral>=0)", II, tt, t);
		/* merge: assert((user_debt>=0))(17, 6, 17) */
		reached[0][6] = 1;
		spin_assert((now.user_debt>=0), "(user_debt>=0)", II, tt, t);
		/* merge: assert((price_eth>0))(17, 7, 17) */
		reached[0][7] = 1;
		spin_assert((now.price_eth>0), "(price_eth>0)", II, tt, t);
		/* merge: assert(!(paused))(17, 8, 17) */
		reached[0][8] = 1;
		spin_assert( !(((int)now.paused)), " !(paused)", II, tt, t);
		/* merge: assert((amount>0))(17, 9, 17) */
		reached[0][9] = 1;
		spin_assert((now.amount>0), "(amount>0)", II, tt, t);
		/* merge: health_factor = ((user_collateral*price_eth)/user_debt)(17, 10, 17) */
		reached[0][10] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 30: // STATE 11 - /home/slade/defi_guardian/generated/models/translated_output.pml:57 - [((health_factor<100))] (26:0:3 - 1)
		IfNotBlocked
		reached[0][11] = 1;
		...
		/* merge: liquidation_executed = 1(26, 13, 26) */
		reached[0][13] = 1;
		...
		;
		_m = 3; goto P999; /* 7 */
	case 31: // STATE 16 - /home/slade/defi_guardian/generated/models/translated_output.pml:62 - [printf('Position healthy: health_factor = %d\\n',health_factor)] (0:26:1 - 1)
		IfNotBlocked
		reached[0][16] = 1;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 32: // STATE 19 - /home/slade/defi_guardian/generated/models/translated_output.pml:64 - [printf('Formal Verification: Execution Completed\\n')] (0:26:1 - 3)
		IfNotBlocked
		reached[0][19] = 1;
		Printf("Formal Verification: Execution Completed\n");
		/* merge: state = 2(26, 20, 26) */
		...
		;
		_m = 3; goto P999; /* 2 */
	case 33: // STATE 22 - /home/slade/defi_guardian/generated/models/translated_output.pml:67 - [((state==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][22] = 1;
		if (!((((int)now.state)==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 34: // STATE 23 - /home/slade/defi_guardian/generated/models/translated_output.pml:68 - [printf('Contract execution terminated.\\n')] (0:29:0 - 1)
		IfNotBlocked
		reached[0][23] = 1;
		Printf("Contract execution terminated.\n");
		/* merge: goto :b0(29, 24, 29) */
		reached[0][24] = 1;
		;
		_m = 3; goto P999; /* 1 */
	case 35: // STATE 29 - /home/slade/defi_guardian/generated/models/translated_output.pml:72 - [-end-] (0:0:0 - 2)
		IfNotBlocked
		reached[0][29] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
